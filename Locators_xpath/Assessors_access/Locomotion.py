...
class Locomotion_score():
    ...
    def closed_excell(self):
       ...
       score = [str(self.sheet.cell(8, 6).value),str(self.sheet.cell(9, 6).value),str(self.sheet.cell(10, 6).value),
                str(self.sheet.cell(11, 6).value),str(self.sheet.cell(12, 6).value)]
       
       self.driver.find_element(By.XPATH,"//*[@id='top']/main/div[1]/div[1]/div/div[2]/div[3]/div[6]/div[1]/div[2]/div[2]/input").send_keys(score[0])
     ...
     #  self.driver.find_element(By.XPATH,f"//*[@id='top']/main/div[1]/div[1]/div/div[2]/div[3]/div[6]/div[5]/input").send_keys(score5)
       for i in range(2,6):
           self.driver.find_element(By.XPATH,"//*[@id='top']/main/div[1]/div[1]/div/div[2]/div[3]/div[6]/div[{}]/input".format(i)).send_keys(score[i-1])
    ...
    def faroff_excell(self):
      ...
      # score5 = str(self.sheet.cell(12, 8).value)
       ...
       score = [str(self.sheet.cell(8, 8).value),str(self.sheet.cell(9, 8).value),str(self.sheet.cell(10, 8).value),
                str(self.sheet.cell(11, 8).value),str(self.sheet.cell(12, 8).value)]
...
#       score5 = str(self.sheet.cell(12, 10).value)
       ...
       score = [str(self.sheet.cell(8, 10).value),str(self.sheet.cell(9, 10).value),str(self.sheet.cell(10, 10).value),
                str(self.sheet.cell(11, 10).value),str(self.sheet.cell(12, 10).value)]
...
#       score5 = str(self.sheet.cell(12, 12).value)
       ...
       score = [str(self.sheet.cell(8, 12).value),str(self.sheet.cell(9, 12).value),str(self.sheet.cell(10, 12).value),
                str(self.sheet.cell(11, 12).value),str(self.sheet.cell(12, 12).value)]
